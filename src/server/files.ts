...
const MIME_TYPES: Record<string, string> = {
  ...
  '.py': 'text/x-python', '.go': 'text/x-go', '.rs': 'text/x-rust', '.c': 'text/x-c', '.h': 'text/x-c', '.cc': 'text/x-c++', '.cpp': 'text/x-c++', '.java': 'text/x-java-source', '.kt': 'text/x-kotlin', '.swift': 'text/x-swift', '.rb': 'text/x-ruby', '.php': 'application/x-php', '.sql': 'application/sql',
